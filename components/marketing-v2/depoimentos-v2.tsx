...
const testimonials: Testimonial[] = [
  {
    ...
    quote:
      'Em 2 semanas, o AutoWhats respondeu a maior parte das dúvidas recorrentes e liberou nossa equipe para casos complexos.',
  ...
  },
  {
    ...
    quote:
      'Reservas e cardápio ficaram automáticos. A equipe parou de responder às mesmas perguntas o dia todo.',
...
export function DepoimentosV2() {
  return (
    <section id="depoimentos" className="py-24 relative scroll-mt-24">
        ...
        <Reveal>
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl md:text-4xl font-bold">
              Empresas que já <span className="gradient-text">automatizaram</span>
            </h2>
            <p className="text-gray-300/80 mt-3">
              Gente de verdade usando no dia a dia para responder mais rápido e vender mais.
            </p>
          </div>
        </Reveal>
