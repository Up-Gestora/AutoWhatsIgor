...
import { MarketingAttributionBootstrap } from '@/components/marketing-v2/marketing-attribution-bootstrap'
...
import { faqs } from '@/components/marketing-v2/faq-data-en'
...
const HOME_TITLE = 'WhatsApp automation with AI for support, CRM, and scheduling | AutoWhats'
const HOME_DESCRIPTION =
  'Automate WhatsApp support with AI trained on your business. Reply faster, qualify leads, run follow-ups, and manage scheduling in one place.'
...
export default function EnHomePage() {
  return (
    <>
      ...
      <main lang="en" className="relative min-h-screen overflow-x-clip">
        ...
        <HeroV2En animatedDemo parallax primaryCtaHref="/en/signup" productHref="#product" />
        ...
        <PrecosV2En />
        <FaqV2En />
        <FinalCtaV2En signupHref="/en/signup" loginHref="/en/login" />
        <FooterV2En homeHref="/en" loginHref="/en/login" signupHref="/en/signup" />
        <WhatsAppFloat />
      </main>
    </>
  )
